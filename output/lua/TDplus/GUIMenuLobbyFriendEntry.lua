...
function PlusRemoveDelay()
    Log("Removed delay for friend requests")
    kPlayerInviteCooldown = 0
end
Event.Hook("Console_nodelay", PlusRemoveDelay)
...
local function OnInviteFriendPressed(self)
    ...
    -- Throttle invitation requests.  Too easy to spam, otherwise.
        ...
        Log("Set cooldown to %s seconds ", kPlayerInviteCooldown)
