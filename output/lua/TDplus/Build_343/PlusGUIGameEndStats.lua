...
class 'PlusGUIGameEndStats'


PlusGUIGameEndStats.name = "PlusGUIGameEndStats"
...
local kpanelURL = "https://ns2panel.com/player/"
...
function PlusGUIGameEndStats:CreateTeamBackground(teamNumber)
	...
	item.background:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.backgroundLeft:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.backgroundRight:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.tableBackground:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.logo:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.teamNameTextShadow:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.teamNameText:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.teamGameStatusShadow:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.teamGameStatus:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.teamPlayerCountShadow:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.teamPlayerCount:SetLayer(kGUILayerMainMenu + 1000)
...
local function CreateScoreboardRow(container, bgColor, textColor, playerName, kills, assists, deaths, acc, score, pdmg, sdmg, timeBuilding, timePlayed, timeComm, steamId, isRookie, hiveSkill)
	...
	item.playerName:SetLayer(kGUILayerMainMenu + 1000)
	...
	if timeComm then
		...
		item.commIcon:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.timePlayed:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.timeBuilding:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.sdmg:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.pdmg:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.score:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.acc:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.deaths:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.assists:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.kills:SetLayer(kGUILayerMainMenu + 1000)
	item.background:AddChild(item.kills)

	return item
end

function PlusGUIGameEndStats:CreateGraphicHeader(text, color, logoTexture, logoCoords, logoSizeX, logoSizeY)
	local item = {}
	...
	item.textShadow:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.text:SetLayer(kGUILayerMainMenu + 1000)
...
local function CreateHeaderRow(container, bgColor, textColor, leftText, rightText)
	...
	item.leftText:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.rightText:SetLayer(kGUILayerMainMenu + 1000)
	item.background:AddChild(item.rightText)

	return item
end

function PlusGUIGameEndStats:CreateTechLogHeader(teamNumber, teamName)
	local item = {}
...
local function CreateTechLogRow(container, bgColor, textColor, timeBuilt, techName, activeRTs, numRes, logoTexture, logoCoords, logoSizeX, logoSizeY, logoColor)
	...
	if timeBuilt ~= "" then
		...
		item.timeBuilt:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.techName:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.activeRTs:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.numRes:SetLayer(kGUILayerMainMenu + 1000)
...
local function CreateCommStatsRow(container, bgColor, textColor, techName, accuracy, efficiency, refill, used, wasted, logoTexture, logoCoords, logoSizeX, logoSizeY, logoColor)
	...
	item.accuracy:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.efficiency:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.refill:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.used:SetLayer(kGUILayerMainMenu + 1000)
	...
	item.wasted:SetLayer(kGUILayerMainMenu + 1000)
	item.background:AddChild(item.wasted)

	return item
end

function PlusGUIGameEndStats:SetPlayerCount(teamItem, playerCount)
...
function PlusGUIGameEndStats:SetGameResult(teamItem, result)
	teamItem.teamGameStatusShadow:SetText(result)
	teamItem.teamGameStatus:SetText(result)
end

function PlusGUIGameEndStats:SetTeamName(teamItem, teamName)
...
function PlusGUIGameEndStats:LoadLastRoundStats()
...
function PlusGUIGameEndStats:SaveLastRoundStats()
...
function PlusGUIGameEndStats:Initialize(guiElement)

	--GUIAnimatedScript.Initialize(self) -- NEW
	...
	self.header:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.closeButton:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.closeText:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.roundDate:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.serverName:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.gameLength:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.mapName:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.sliderBarBg:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.slider:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.contentBackground:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.contentStencil:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.background:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.teamStatsTextShadow:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.teamStatsText:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.yourStatsTextShadow:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.yourStatsText:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.techLogTextShadow:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.techLogText:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.hiveSkillGraphTextShadow:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.hiveSkillGraphText:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.rtGraphTextShadow:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.rtGraphText:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.killGraphTextShadow:SetLayer(kGUILayerMainMenu + 1000)
	...
	self.killGraphText:SetLayer(kGUILayerMainMenu + 1000)
...
function PlusGUIGameEndStats:Uninitialize()
	...
	--loadedthestats = false
end

function PlusGUIGameEndStats:SetIsVisible(visible)
	...
	local visibleStats = self.teamStatsTextShadow:GetIsVisible() or #self.statsCards > 0 or #self.rtGraphs > 0
...
function PlusGUIGameEndStats:GetIsVisible()
...
function PlusGUIGameEndStats:RepositionStats()
...
function PlusGUIGameEndStats:UpdateRowHighlight()
...
function PlusGUIGameEndStats:UpdateSlidebar()
...
function PlusGUIGameEndStats:UpdateCloseButton()
	local mouseX, mouseY = Client.GetCursorPosScreen()
...
function PlusGUIGameEndStats:UpdateVisibleUI()
...
function PlusGUIGameEndStats:ProcessStats()
	...
	--self:Uninitialize()
	--Shared.Message("init due to progressing?")
	--self:Initialize()
	...
	if #techLogTable > 0 or #buildingSummaryTable > 0 then
		...
		if commanderStats then
			...
			if commanderStats.medpackResUsed > 0 or commanderStats.medpackResExpired > 0 then
				table.insert(self.techLogs[1].rows, CreateCommStatsRow(self.techLogs[1].header.tableBackground, row % 2 == 0 and kMarinePlayerStatsEvenColor or kMarinePlayerStatsOddColor, kMarineHeaderRowTextColor, "Medpacks", printNum(commanderStats.medpackAccuracy) .. "%", printNum(commanderStats.medpackEfficiency) .. "%", commanderStats.medpackRefill, commanderStats.medpackResUsed, commanderStats.medpackResExpired, "ui/buildmenu.dds", {80,80,160,160}, 24, 24, kIconColors[1]))
				row = row + 1
			end

			if commanderStats.ammopackResUsed > 0 or commanderStats.ammopackResExpired > 0 then
				table.insert(self.techLogs[1].rows, CreateCommStatsRow(self.techLogs[1].header.tableBackground, row % 2 == 0 and kMarinePlayerStatsEvenColor or kMarinePlayerStatsOddColor, kMarineHeaderRowTextColor, "Ammopacks", "-", printNum(commanderStats.ammopackEfficiency) .. "%", commanderStats.ammopackRefill, commanderStats.ammopackResUsed, commanderStats.ammopackResExpired, "ui/buildmenu.dds",  {80,80,160,160}, 24, 24, kIconColors[1]))
				row = row + 1
			end

			if commanderStats.catpackResUsed > 0 or commanderStats.catpackResExpired > 0 then
				table.insert(self.techLogs[1].rows, CreateCommStatsRow(self.techLogs[1].header.tableBackground, row % 2 == 0 and kMarinePlayerStatsEvenColor or kMarinePlayerStatsOddColor, kMarineHeaderRowTextColor, "Catpacks", "-", printNum(commanderStats.catpackEfficiency) .. "%", "-", commanderStats.catpackResUsed, commanderStats.catpackResExpired, "ui/buildmenu.dds",  {80,80,160,160}, 24, 24, kIconColors[1]))
			end
		end
...
function PlusGUIGameEndStats:Update()

		if loadedthestats == false then
				self:ProcessStats()
				loadedthestats = true
			end
...
function PlusGUIGameEndStats:GetShouldUpdate()
	return true
end
...
function PlusGUIGameEndStats:SendKeyEvent(key, down)
	...
	if self:GetIsVisible() then
		...
		elseif key == InputKey.MouseButton0 and down then
			...
			if self.lastRow and not self.hoverMenu.background:GetIsVisible() then
				...
				Client.ShowWebpage(string.format("%s%s", kpanelURL, tostring(Shared.ConvertSteamId64To32(tostring(self.lastRow.steamId))) ))
...
function PlusGUIGameEndStats:OnResolutionChanged(oldX, oldY, newX, newY)
